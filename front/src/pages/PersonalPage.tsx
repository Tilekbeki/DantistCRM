...
const PersonalPage = () => {
  ...
  const handleOk = async (data: any) => {
    ...
    console.log('Данные для созданияzzzz персонала:', {
  ...
  return (
    <TemplatePage title="Персонал" description="Управление базой данных персонала" toggleModalState={toggleModalState}>
      <PersonalList />
      <EntityModal
        open={isModalOpen}
